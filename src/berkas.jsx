  ...
  return (
    <div className="relative my-8">
      <div className="flex items-center justify-center">
        <div
          className="flex-1 h-px bg-linear-to-r from-transparent via-pink-300 to-transparent"
          aria-hidden="true"
        ></div>
        <div className="mx-4 relative">
          <div className="w-12 h-12 rounded-full bg-white shadow-lg border-4 border-pink-300 flex items-center justify-center">
            <i
              className="fas fa-gift text-pink-500 text-xl"
              aria-hidden="true"
            ></i>
          </div>
          <div
        ...
        <div
          className="flex-1 h-px bg-linear-to-r from-transparent via-purple-300 to-transparent"
          aria-hidden="true"
        ></div>
      </div>
